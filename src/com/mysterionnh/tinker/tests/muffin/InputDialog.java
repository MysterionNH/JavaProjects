...
public class InputDialog {
    ...
    public boolean isAgeValide(String age) {
        if (age == null || age.isEmpty() || !("".equals(extractLetter(age)))) {
            _age = JOptionPane.showInputDialog("Dein Alter enthält Fehler. Bitte gib deinen Alter ein.\nStelle sicher das es nur Zahlen enthählt und du das Feld nicht leer lässt.\nFalls du beenden möchtest klicke jetzt auf \"Abbrechen\".");
    ...
    public boolean isNameValide(String name) {
        if (name == null || name.isEmpty() || !("".equals(extractNumber(name)))) {
            _name = JOptionPane.showInputDialog("Dein Name enthält Fehler. Bitte gib deinen Namen ein.\nStelle sicher das er keine Zahlen enthählt und du das Feld nicht leer lässt.\nFalls du beenden möchtest klicke jetzt auf \"Abbrechen\".");
